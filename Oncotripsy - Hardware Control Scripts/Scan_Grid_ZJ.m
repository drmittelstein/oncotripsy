...
params.Scope.averaging = 64;   % Set to configure oscilloscope 
...
params.Scan.dim1_step = 2.5e-5 / params.Stages.step_distance; 
% Motor steps between each aquisition

dim1_width = 0.5e-4 / params.Stages.step_distance; 
...
params.Scan.dim2_step = 2.5e-5 / params.Stages.step_distance;
% Motor steps between each acquisition

dim2_width = 0.5e-4 / params.Stages.step_distance;
